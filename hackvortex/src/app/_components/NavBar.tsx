...
const Logo = (props: any) => {
  return (
    <svg height={32} viewBox="0 0 120 28" xmlns="/logo.png" {...props}>
      <path
...
const NAV_ITEMS: Array<NavItem> = [
  {
    ...
    children: [
      {
        label: 'Land life',
        subLabel: 'Animals that live in land',
        href: '/animals/land-animals',
      },
      {
        label: 'Sea life',
        subLabel: 'Animals that live in the sea',
        href: '/animals/sea-animals',
      },
      {
        label: 'Aerial life',
        subLabel: 'Animals that live in the sky',
        href: '/animals/aerial-animals',
      }
    ],
  },
  {
